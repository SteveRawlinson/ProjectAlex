...
b = DebounceSensor() # create one of these 
c = DebounceSensor() # create one of these 
d = DebounceSensor() # create one of these 
e = DebounceSensor() # create one of these 
f = DebounceSensor() # create one of these 
g = DebounceSensor() # create one of these 
h = DebounceSensor() # create one of these 
i = DebounceSensor() # create one of these 
j = DebounceSensor() # create one of these 
k = DebounceSensor() # create one of these 
l = DebounceSensor() # create one of these 
m = DebounceSensor() # create one of these 
n = DebounceSensor() # create one of these 
o = DebounceSensor() # create one of these 
p = DebounceSensor() # create one of these 
q = DebounceSensor() # create one of these 



a.init('IS6', 'LS106', 2, 2) # invoke this for the sensor pair
b.init('IS7', 'LS107', 2, 2) # invoke this for the sensor pair
c.init('IS8', 'LS108', 2, 2) # invoke this for the sensor pair
d.init('IS9', 'LS109', 2, 2) # invoke this for the sensor pair
e.init('IS10', 'LS110', 2, 2) # invoke this for the sensor pair
f.init('IS5', 'LS105', 2, 2) # invoke this for the sensor pair
g.init('IS12', 'LS112', 2, 2) # invoke this for the sensor pair
h.init('IS13', 'LS113', 2, 2) # invoke this for the sensor pair
i.init('IS14', 'LS114', 2, 2) # invoke this for the sensor pair
j.init('IS15', 'LS115', 2, 2) # invoke this for the sensor pair
k.init('IS16', 'LS116', 2, 2) # invoke this for the sensor pair
l.init('IS17', 'LS117', 2, 2) # invoke this for the sensor pair
m.init('IS23', 'IS18', 2, 2) # invoke this for the sensor pair
n.init('IS24', 'IS19', 2, 2) # invoke this for the sensor pair
o.init('IS25', 'IS20', 2, 2) # invoke this for the sensor pair
p.init('IS26', 'IS21', 2, 2) # invoke this for the sensor pair
q.init('IS27', 'IS22', 2, 2) # invoke this for the sensor pair
