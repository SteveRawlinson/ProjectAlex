...
SLOWTIMEMAP = {
    # class 47
    "class47": {'FPK P7': 8, "NORTH FAST": 13, "NSG P2": 5, "Nth Fast Outer 1": 5},
    # Mallard
    ...
    # Underground
    1087: {"FPK P3": 11, "AAP P2": 4, "NSG P1": 13, "PAL P1": 6, "AAP P4": 7, "FPK P1": 13, "FPK P4": 5, "AAP P1": 5, "NSG P2": 3, "FPK P2": 8,
